      ...
      <div>
        ...
        <div className="loader-container">
          ...
          <div className="holo-numbers">
            <div
              className="number"
              style={{ top: "40%", left: "30%", animationDelay: "0.5s" }}
            >
              0xFF
            </div>
            <div
              className="number"
              style={{ top: "50%", left: "60%", animationDelay: "1.5s" }}
            >
              0x0A
            </div>
            <div
              className="number"
              style={{ top: "60%", left: "40%", animationDelay: "2.5s" }}
            >
              0xB4
            </div>
            <div
              className="number"
              style={{ top: "30%", left: "50%", animationDelay: "3.5s" }}
            >
              0x3D
            </div>
            <div
            ...
            <div
              className="number"
              style={{ top: "20%", left: "70%", animationDelay: "5.5s" }}
            >
              0x19
            </div>
          </div>
...
const StyledWrapper = styled.div`
  ...
  .core {
    ...
    box-shadow: 0 0 20px rgba(255, 255, 255, 0.8),
      0 0 40px rgba(0, 221, 255, 0.6), 0 0 60px rgba(255, 0, 222, 0.4);
  }
